...
void FOUR_POSITION_SWITCH::operator ()(void) {
    ...
    case FOUR_POSITION_SWITCH_v1::Off:                            if( I1 && !I2 && !I3) {  State = FOUR_POSITION_SWITCH_v1::Momentary_forward_up_right;   Value2++; }         //if we was off, we go mom.
                                                                  if(!I1 &&  I2 && !I3) {  State = FOUR_POSITION_SWITCH_v1::Momentary_backward_down_left; Value2++; } break;  //if we was off, we go mom.
...
void VALVE_WITH_FLOAT::operator ()(void) {
	...
	case FOUR_POSITION_SWITCH_v1::Momentary_float:                 Q1 = false; Q2 = true;  Q3 = true;  Q4 = true;  break;
	case FOUR_POSITION_SWITCH_v1::held_float:                      Q1 = false; Q2 = true;  Q3 = true;  Q4 = true;  break;
